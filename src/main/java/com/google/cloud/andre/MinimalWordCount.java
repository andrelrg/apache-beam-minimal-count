 ...
 */
package com.google.cloud.andre;

import com.google.cloud.andre.common.ExamplesUtils;
...
public class MinimalWordCount {
    ...
    public static void main(String[] args) {
        ...
        // remove hamlet
        p.apply(TextIO.read().from("gs://apache-beam-samples/shakespeare/hamlet.txt"))
                ...
                .apply("ExtractWords", ParDo.of(new DoFn<String, String>() {
                    ...
                    public void processElement(ProcessContext c) {
                        for (String word : c.element().split(ExamplesUtils.TOKENIZER_PATTERN)) {
                            if (!word.isEmpty()) {
                                c.output(word);
                            }
                        }
                ...
                .apply(TextIO.write().to("pasta/wordcounts"));
